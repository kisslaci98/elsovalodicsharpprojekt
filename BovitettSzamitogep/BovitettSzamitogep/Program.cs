...
namespace BovitettSzamitogep
{
    ...
    class Szam
    {
        ...
        //ez itt a propertybe ágyazott mezőérték
        ...
        public void ElsoKetSzamMertaniKozepe(Szam szam)
        {
            ...
            {
                Console.WriteLine($"Az első két szám közül legalább az egyik negatív.");
            }
            
        }
        public void HaromSzamSzamtaniKozepe(Szam szam, Szam masikSzam)
        {
            Console.WriteLine($"A három szám számtani közepe: {((double)this.BekertErtek + szam.BekertErtek + masikSzam.BekertErtek) / 3}");
        }
